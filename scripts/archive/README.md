...
- `tunes-cover-lanes-2026-07-27/` - exact pre-refactor snapshot of the lane-driven Tunes header workflow and its weekly, bulk, regeneration, artist, backend, configuration, policy, blocklist, and history dependencies. Kept as a restoration snapshot after Tunes headers moved to factual cover summaries plus freeform AI art direction.
