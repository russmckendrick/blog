...
relatedTerms: ["ci-cd", "automation", "azure-devops", "infrastructure-as-code", "observability", "security", "immutable-infrastructure"]
...
Most "DevOps tools" - Jenkins, GitHub Actions, [Terraform](/glossary/terraform/), [Ansible](/glossary/ansible/), [Kubernetes](/glossary/kubernetes/) - only deliver value when wrapped in those practices. Adopting the tooling without the cultural shift tends to produce the same operational pain with extra YAML.
