...
category: "Practice"
relatedTerms: ["devops", "infrastructure-as-code", "blue-green-deployment", "canary-deployment"]
...
Common CI/CD platforms include GitHub Actions, GitLab CI, Jenkins, CircleCI, Buildkite, and Argo Workflows. The platform matters less than the discipline of keeping the pipeline fast, deterministic, and trustworthy.
