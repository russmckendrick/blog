...
cover:
  image: "../../assets/2014-10-20-yosemite-installation/blog-cover-2014-10-20-yosemite-installation.png"
tags:
  - "macOS"
  - "Tools"
aliases:
...
```bash frame="terminal" title="Yosemite Installation 1/3"
...
```bash frame="terminal" title="Yosemite Installation 2/3"
...
```bash frame="terminal" title="Yosemite Installation 3/3"
