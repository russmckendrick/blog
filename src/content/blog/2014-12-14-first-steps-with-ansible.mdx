...
cover:
  image: "../../assets/2014-12-14-first-steps-with-ansible/blog-cover-2014-12-14-first-steps-with-ansible.png"
tags:
  - "Linux"
  - "Automation"
...
```bash frame="terminal" title="First Steps with Ansible 1/3"
brew update
...
```bash frame="terminal" title="First Steps with Ansible 2/3"
...
```bash frame="terminal" title="First Steps with Ansible 3/3"
- name: install ntp
