...
cover:
  image: "../../assets/2015-11-15-puppet-enterprise-aws-security-groups/blog-cover-2015-11-15-puppet-enterprise-aws-security-groups.png"
tags:
  - "Automation"
  - "AWS"
aliases:
...
```bash frame="terminal" title="Puppet Enterprise & AWS Security Groups 1/2"
PuppetDB configured.
...
```bash frame="terminal" title="Puppet Enterprise & AWS Security Groups 2/2"
