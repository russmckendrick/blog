...
cover:
  image: "../../assets/2018-01-28-shopping-for-containers/blog-cover-2018-01-28-shopping-for-containers.png"
tags:
  - "Docker"
  - "Tools"
aliases:
...
<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_1.png" alt="graphical user interface, application" />
...
```bash frame="terminal" title="Shopping for Containers 1/4"
...
<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_2.png" alt="graphical user interface, text, application, website" />
...
<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_3.png" alt="graphical user interface, text, application, email" />
...
<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_4.png" alt="graphical user interface, application" />
...
```bash frame="terminal" title="Shopping for Containers 2/4"
$ docker pull php
```
...
<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_5.png" alt="graphical user interface, text, application, email" />

However, it’s listing on the Docker Store gives a different story;

<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_6.png" alt="graphical user interface, text, application" />
...
<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_7.png" alt="graphical user interface, application, website" />

Let’s try pulling the image from an un-authenciated Docker client by running;

```bash frame="terminal" title="Shopping for Containers 3/4"
$ docker pull store/couchbase/couchbase:3.1.5
```


<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_8.png" alt="graphical user interface, text" />

Logging in using the `docker login` command then trying to `docker pull` the image has a lot more success;

<Img src="/assets/2018-01-28-shopping-for-containers/img/2018-01-28_shopping-for-containers_9.png" alt="text" />

From there I could for example run the following command to launch Couchbase;

```bash frame="terminal" title="Shopping for Containers 4/4"
