...
date: 2021-04-25
cover:
  image: "../../assets/2021-04-25-azure-devops-multistage-pipelines/blog-cover-2021-04-25-azure-devops-multistage-pipelines.png"
tags:
  - "Azure"
  - "DevOps"
...
<Img src="/assets/2021-04-25-azure-devops-multistage-pipelines/images/01.png" alt="graphical user interface, text, application" />
...
{/* Old gallery removed - please add images manually if needed */}
   <Img src="/assets/2021-04-25-azure-devops-multistage-pipelines/images/02.png" alt="graphical user interface, application" />
   <Img src="/assets/2021-04-25-azure-devops-multistage-pipelines/images/03.png" alt="graphical user interface, application" />
...
```bash frame="terminal" title="Resource Group"
``` yaml
- stage: "SetupRG"
...
```bash frame="terminal" title="Azure Container Registry"
``` yaml
- stage: "SetupACR"
...
```bash frame="terminal" title="Build, Tag and Push the container image"
``` yaml
...
```bash frame="terminal" title="Azure App Services"
``` yaml
...
<Img src="/assets/2021-04-25-azure-devops-multistage-pipelines/images/04.png" alt="graphical user interface, text, application, email" />

Once you click through to approve the deployment you should see something which looks like the following;

<Img src="/assets/2021-04-25-azure-devops-multistage-pipelines/images/05.png" alt="graphical user interface, application" />
...
<Img src="/assets/2021-04-25-azure-devops-multistage-pipelines/images/06.png" alt="graphical user interface, application" />

When the pipeline is next triggered you should see something like the following;

<Img src="/assets/2021-04-25-azure-devops-multistage-pipelines/images/07.png" alt="graphical user interface, application" />
