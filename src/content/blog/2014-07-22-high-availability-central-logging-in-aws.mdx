...
cover:
  image: "../../assets/2014-07-22-high-availability-central-logging-in-aws/blog-cover-2014-07-22-high-availability-central-logging-in-aws.png"
tags:
  - "Code"
  - "Tools"
  - "AWS"
...
```json frame="terminal" title="High Availability Central Logging in AWS 1/2"
{
 “Version”: “2012–10–17”,
 “Statement”: [
 {
...
```bash frame="terminal" title="High Availability Central Logging in AWS 2/2"
