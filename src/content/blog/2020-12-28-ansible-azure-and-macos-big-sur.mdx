...
date: 2020-12-28
cover:
  image: "../../assets/2020-12-28-ansible-azure-and-macos-big-sur/blog-cover-2020-12-28-ansible-azure-and-macos-big-sur.png"
tags:
  - "Ansible"
  - "macOS"
  - "Azure"
...
<Img src="/assets/2020-12-28-ansible-azure-and-macos-big-sur/images/2020-12-28_ansible-azure-and-macos-big-sur-01.png" alt="text" />
...
```bash frame="terminal" title="Set some secrets"
...
<Img src="/assets/2020-12-28-ansible-azure-and-macos-big-sur/images/2020-12-28_ansible-azure-and-macos-big-sur-02.png" alt="graphical user interface" />
...
<Img src="/assets/2020-12-28-ansible-azure-and-macos-big-sur/images/2020-12-28_ansible-azure-and-macos-big-sur-03.png" alt="graphical user interface, application" />

For those that interested the Dockerfile for the image can be found below …

```bash frame="terminal" title="Dockerfile"
