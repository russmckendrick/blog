...
cover:
  image: "../../assets/2016-12-27-playing-with-infinit-docker/blog-cover-2016-12-27-playing-with-infinit-docker.png"
tags:
  - "Docker"
  - "Tools"
aliases:
...
https://x.com/russmckendrick/status/806153366573318145
...
```bash frame="terminal" title="Playing with Infinit & Docker 1/37"
sudo su -
apt-get update -y
apt-get upgrade -y
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 2/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 3/37"
cd /opt/infinit
...
```bash frame="terminal" title="Playing with Infinit & Docker 4/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 5/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 6/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 7/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 8/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 9/37"
df -h
cd ~/mnt
touch wibble
echo "working" > rah
...
<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_1.png" alt="graphical user interface, text" />
...
```bash frame="terminal" title="Playing with Infinit & Docker 10/37"
infinit-device --transmit --user --as russ
```


<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_2.png" alt="graphical user interface, text" />

#### Instance #2

To receive our user credentials we need to run the following command;

```bash frame="terminal" title="Playing with Infinit & Docker 11/37"
...
<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_3.png" alt="a screenshot of a computer" />

and on **Instance #1** you should have confirmation that the credentials have been transmitted;

<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_4.png" alt="graphical user interface, text" />

Now we have our user on our second instance we can fetch the network we created on our first instance by running;

```bash frame="terminal" title="Playing with Infinit & Docker 12/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 13/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 14/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 15/37"
infinit-volume --mount --as russ --name my-volume --mountpoint ~/mnt --allow-root-creation --cache --publish --daemon
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 16/37"
ls -lhat ~/mnt/
cat ~/mnt/rah
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 17/37"
echo "still working" >> ~/mnt/wibble
```


<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_5.png" alt="text" />

We still have our volume mounted on our first instance, lets go back there and check out the contents of `~/mnt` by running;

```bash frame="terminal" title="Playing with Infinit & Docker 18/37"
ls -lhat ~/mnt
cat ~/mnt/wibble
```
...
<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_6.png" alt="a screenshot of a computer" />
...
```bash frame="terminal" title="Playing with Infinit & Docker 19/37"
infinit-user --export --full --name russ --output russ.user
```


<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_7.png" alt="text" />
...
```bash frame="terminal" title="Playing with Infinit & Docker 20/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 21/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 22/37"
infinit-device --transmit --user --as russ
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 23/37"
infinit-device --receive --user --name russ
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 24/37"
infinit-network --fetch --as russ --name blogpost
infinit-volume --fetch --as russ --name my-volume
infinit-network --link --as russ --name blogpost
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 25/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 26/37"
cd ~/mnt/
ls -lhat
open .
```
...
<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_8.png" alt="text" />

and the finder;

<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_9.png" alt="graphical user interface, text" />

Which means you can simply drop a file in the finder;

<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_10.png" alt="diagram" />

To make it available to all instances in the overlay network;

<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_11.png" alt="a screenshot of a computer" /><Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_12.png" alt="a screenshot of a computer" />
...
```bash frame="terminal" title="Playing with Infinit & Docker 27/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 28/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 29/37"
docker ps
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 30/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 31/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 32/37"
docker volume list
```


<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_13.png" alt="graphical user interface, text" />

Now that our volume is available we can attach it to a container by running;

```bash frame="terminal" title="Playing with Infinit & Docker 33/37"
...
```bash frame="terminal" title="Playing with Infinit & Docker 34/37"
ls -lhat /mnt
...
<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_14.png" alt="a screenshot of a computer" />

Typing `exit` will stop and remove the container, you can check that the container has been removed by running;

```bash frame="terminal" title="Playing with Infinit & Docker 35/37"
docker ps -a
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 36/37"
docker run -it --rm --volume-driver infinit -v russ/my-volume:/mnt alpine ash
```
...
```bash frame="terminal" title="Playing with Infinit & Docker 37/37"
ls -lhat /mnt
cat /mnt/docker
exit
```
...
<Img src="/assets/2016-12-27-playing-with-infinit-docker/img/2016-12-27_playing-with-infinit-docker_15.png" alt="a screenshot of a computer" />
