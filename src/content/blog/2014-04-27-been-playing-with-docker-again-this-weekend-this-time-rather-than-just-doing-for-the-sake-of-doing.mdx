...
cover:
  image: "../../assets/2014-04-27-been-playing-with-docker-again-this-weekend-this-time-rather-than-just-doing-for-the-sake-of-doing/blog-cover-2014-04-27-been-playing-with-docker-again-this-weekend-this-time-rather-than-just-doing-for-the-sake-of-doing.png"
tags:
  - "Docker"
  - "Tools"
aliases:
...
```bash frame="terminal" title="Deploying a Stable Docker Setup on CentOS with Shipyard 1/3"
...
```bash frame="terminal" title="Deploying a Stable Docker Setup on CentOS with Shipyard 2/3"
...
```bash frame="terminal" title="Deploying a Stable Docker Setup on CentOS with Shipyard 3/3"
