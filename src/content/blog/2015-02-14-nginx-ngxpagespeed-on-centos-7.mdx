...
cover:
  image: "../../assets/2015-02-14-nginx-ngxpagespeed-on-centos-7/blog-cover-2015-02-14-nginx-ngxpagespeed-on-centos-7.png"
tags:
  - "Linux"
  - "Web"
aliases:
...
```bash frame="terminal" title="NGINX & ngx_pagespeed on CentOS 7 1/8"
...
```bash frame="terminal" title="NGINX & ngx_pagespeed on CentOS 7 2/8"
useradd nginx
...
```bash frame="terminal" title="NGINX & ngx_pagespeed on CentOS 7 3/8"
cd /usr/local/src/
...
```bash frame="terminal" title="NGINX & ngx_pagespeed on CentOS 7 4/8"
cd /usr/local/src/
...
```bash frame="terminal" title="NGINX & ngx_pagespeed on CentOS 7 5/8"
...
```bash frame="terminal" title="NGINX & ngx_pagespeed on CentOS 7 6/8"
...
```bash frame="terminal" title="NGINX & ngx_pagespeed on CentOS 7 7/8"
...
```bash frame="terminal" title="NGINX & ngx_pagespeed on CentOS 7 8/8"
pagespeed on;
