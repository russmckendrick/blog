...
cover:
  image: "../../assets/2017-01-02-trying-out-elastic-beats/blog-cover-2017-01-02-trying-out-elastic-beats.png"
tags:
  - "Docker"
  - "DevOps"
  - "Tools"
...
<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_0.png" alt="a person playing a drum set" />
...
```bash frame="terminal" title="Trying out Elastic Beats 1/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 2/21"
docker-machine create \
    --driver digitalocean \
    --digitalocean-access-token your-do-token-goes-here \
    --digitalocean-region lon1 \
...
```bash frame="terminal" title="Trying out Elastic Beats 3/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 4/21"
...
<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_1.png" alt="text" />

I checked that all three Docker hosts were correctly in the cluster;

```bash frame="terminal" title="Trying out Elastic Beats 5/21"
docker $(docker-machine config manager) node ls
```


<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_2.png" alt="a screenshot of a computer" />
...
```bash frame="terminal" title="Trying out Elastic Beats 6/21"
docker $(docker-machine config manager) network create --driver overlay elk
```


<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_3.png" alt="graphical user interface, text" />

Then I created the Elasticsearch service;

```bash frame="terminal" title="Trying out Elastic Beats 7/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 8/21"
docker $(docker-machine config manager) service create \
  --name kibana \
  --network elk \
  --publish 5601:5601 \
...
<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_4.png" alt="text" />

After a minute I checked that the two services were running as expected using;

```bash frame="terminal" title="Trying out Elastic Beats 9/21"
docker $(docker-machine config manager) service ls
```


<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_5.png" alt="text" />
...
```bash frame="terminal" title="Trying out Elastic Beats 10/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 11/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 12/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 13/21"
docker-machine ssh worker01 sudo /etc/init.d/metricbeat start
```


<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_6.png" alt="text" />
...
```bash frame="terminal" title="Trying out Elastic Beats 14/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 15/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 16/21"
...
<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_7.png" alt="graphical user interface, text, application, email" />
...
<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_8.png" alt="graphical user interface, text, application, table" />

Clicking on **Dashboard**, and then selecting **Metricbeat-overview** gave me the following view;

<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_9.png" alt="graphical user interface, table" />

From there I clicked on **Load/CPU** and **Processes** gave me the following dashboards;

<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_10.png" alt="graphical user interface" /><Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_11.png" alt="chart" />
...
```bash frame="terminal" title="Trying out Elastic Beats 17/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 18/21"
docker $(docker-machine config manager) service create \
  --name viz \
  --publish 8080:8080 \
...
<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_13.png" alt="text" />

Running the following showed me my cluster

```bash frame="terminal" title="Trying out Elastic Beats 19/21"
...
```bash frame="terminal" title="Trying out Elastic Beats 20/21"
...
<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_14.png" alt="chart, treemap chart" />

Going back to Kibana, I selected the **Metricbeat Docker** dashboard and was greeted by the following;

<Img src="/assets/2017-01-02-trying-out-elastic-beats/img/2017-01-02_trying-out-elastic-beats_15.png" alt="graphical user interface" />
...
```bash frame="terminal" title="Trying out Elastic Beats 21/21"
