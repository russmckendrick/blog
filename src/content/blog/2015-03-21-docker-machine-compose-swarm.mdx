...
cover:
  image: "../../assets/2015-03-21-docker-machine-compose-swarm/blog-cover-2015-03-21-docker-machine-compose-swarm.png"
tags:
  - "Docker"
aliases:
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 1/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 2/39"
 docker-machine -v
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 3/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 4/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 5/39"
 docker-machine ls
 NAME ACTIVE DRIVER STATE URL SWARM
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 6/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 7/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 8/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 9/39"
 docker-machine ls
 NAME ACTIVE DRIVER STATE URL SWARM
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 10/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 11/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 12/39"
 docker-machine ls
 NAME ACTIVE DRIVER STATE URL SWARM
 dotesting * digitalocean Running tcp://45.55.134.248:2376
 testing virtualbox Running tcp://192.168.99.100:2376
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 13/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 14/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 15/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 16/39"
 docker-machine env compose
 export DOCKER_TLS_VERIFY=yes
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 17/39"
web:
 cover:
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 18/39"
 tree -a
 .
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 19/39"
 docker-compose pull
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 20/39"
 docker-compose up -d
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 21/39"
 docker-compose ps
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 22/39"
...
<Img src="/assets/2015-03-21-docker-machine-compose-swarm/img/2015-03-21_docker-machine-compose-swarm_1.png" alt="phpinfo" />

Once the containers are running you can connect to them using docker exec;

```bash frame="terminal" title="Docker Machine, Compose & Swarm 23/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 24/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 25/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 26/39"
 docker-machine ls
 NAME ACTIVE DRIVER STATE URL SWARM
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 27/39"
docker-machine create \
 → -d virtualbox \
 → — swarm \
 → — swarm-master \
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 28/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 29/39"
 docker-machine create \
 → -d virtualbox \
 → — swarm \
 → — swarm-discovery token://63e7a1adb607ce4db056a29b1f5d30cf \
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 30/39"
 docker-machine ls
 NAME ACTIVE DRIVER STATE URL SWARM
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 31/39"
 docker info
 Containers: 3
 Nodes: 2
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 32/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 33/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 34/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 35/39"
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 36/39"
 docker run -d -p 80:80 russmckendrick/nginx-php
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 37/39"
 docker run -d -p 80:80 russmckendrick/nginx-php
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 38/39"
 docker ps
 CONTAINER ID IMAGE COMMAND CREATED STATUS PORTS NAMES
...
```bash frame="terminal" title="Docker Machine, Compose & Swarm 39/39"
