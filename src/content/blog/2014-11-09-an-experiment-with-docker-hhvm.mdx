...
cover:
  image: "../../assets/2014-11-09-an-experiment-with-docker-hhvm/blog-cover-2014-11-09-an-experiment-with-docker-hhvm.png"
tags:
  - "Docker"
  - "Tools"
aliases:
...
```bash frame="terminal" title="An Experiment with Docker & HHVM 1/2"
### Dockerfile
#
...
```bash frame="terminal" title="An Experiment with Docker & HHVM 2/2"
### Dockerfile
#
# See https://github.com/russmckendrick/docker/
...
<Img src="/assets/2014-11-09-an-experiment-with-docker-hhvm/img/2014-11-09_an-experiment-with-docker-hhvm_1.jpg" alt="docker-success_x7gdrq" />
