...
cover:
  image: "../../assets/2019-09-01-quickly-launch-an-azure-aks-cluster/blog-cover-2019-09-01-quickly-launch-an-azure-aks-cluster.png"
tags:
  - "Azure"
  - "Kubernetes"
aliases:
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 1/11"
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 2/11"
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 3/11"
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 4/11"
$ az aks install-cli
```
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 5/11"
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 6/11"
$ kubectl get nodes
```
...
<Img src="/assets/2019-09-01-quickly-launch-an-azure-aks-cluster/img/2019-09-01_quickly-launch-an-azure-aks-cluster_1.png" alt="text" />

Also, you should be able to see the cluster in the [Azure Portal](https://portal.azure.com/);

<Img src="/assets/2019-09-01-quickly-launch-an-azure-aks-cluster/img/2019-09-01_quickly-launch-an-azure-aks-cluster_2.png" alt="graphical user interface, text, application" />
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 7/11"
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 8/11"
...
<Img src="/assets/2019-09-01-quickly-launch-an-azure-aks-cluster/img/2019-09-01_quickly-launch-an-azure-aks-cluster_3.gif" alt="a person holding a stack of boxes" />

The final Azure resource to remove will the resource group, to do this run;

```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 9/11"
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 10/11"
...
```bash frame="terminal" title="Quickly launch an Azure AKS Cluster 11/11"
...
<Img src="/assets/2019-09-01-quickly-launch-an-azure-aks-cluster/img/2019-09-01_quickly-launch-an-azure-aks-cluster_4.gif" alt="a few men sitting in front of a computer" />
