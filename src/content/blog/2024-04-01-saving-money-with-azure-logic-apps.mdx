...
cover:
  image: "../../assets/2024-04-01-saving-money-with-azure-logic-apps/blog-cover-2024-04-01-saving-money-with-azure-logic-apps.png"
draft: false
showToc: true
avatar: "suit"
tags:
...
```text frame="terminal" title="Cloning to accompanying repo"
...
```text frame="terminal" title="Setting some environment variables"
...
```text frame="terminal" title="Create the resource group"
az group create \
...
```text frame="terminal" title="Create the user managed identity"
az identity create \
...
```text frame="terminal" title="Granting RBAC permissions"
...
```text frame="terminal" title="Create the Azure Logic App"
...
```text frame="terminal" title="Do you need to install the extension?"
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/deploying-the-logic-app-and-supporting-resources/01.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/deploying-the-logic-app-and-supporting-resources/02.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/deploying-the-logic-app-and-supporting-resources/03.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/deploying-the-logic-app-and-supporting-resources/04.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
```text frame="terminal" title="Launching three test VMs"
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/creating-some-target-resources/01.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/creating-some-target-resources/02.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/vm-running-the-logic-app-stop/01.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/vm-running-the-logic-app-stop/02.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/vm-running-the-logic-app-stop/03.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/vm-running-the-logic-app-stop/04.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/vm-running-the-logic-app-start/01.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/vm-running-the-logic-app-start/02.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/vm-running-the-logic-app-start/03.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/vm-running-the-logic-app-start/04.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
```text frame="terminal" title="Removing the demo Virtual Machines and Group"
export RESOURCE_GROUP_NAME="rg-demo-vms-uks"
...
<Img src="/assets/2024-04-01-saving-money-with-azure-logic-apps/images/working-through-the-logic-app/vm-full-logic-app.png" alt="The full machine workflow" />
...
```json frame="code" title="Json" showLineNumbers
{
  "type": "Recurrence",
  "recurrence": {
    "frequency": "Week",
...
<Img src="/assets/2024-04-01-saving-money-with-azure-logic-apps/images/working-through-the-logic-app/vm-1of2.png" alt="VM 1of 2" />

Clicking on the right arrow will take us to the second virtual machine:

<Img src="/assets/2024-04-01-saving-money-with-azure-logic-apps/images/working-through-the-logic-app/vm-2of2.png" alt="VM 2 of 2" />
...
```text frame="code" title="Text" showLineNumbers
...
<Img src="/assets/2024-04-01-saving-money-with-azure-logic-apps/images/working-through-the-logic-app/vm-2of2results.png" alt="The full machine workflow" />
...
```text frame="terminal" title="Create the resource group, identity and assign Reader access"
...
```text frame="terminal" title="Granting Network Contributor permissions"
az role assignment create \
	--assignee-principal-type "ServicePrincipal" \
	--assignee-object "$(az identity show --resource-group $RESOURCE_GROUP_NAME --name $MANAGED_ID_NAME --query principalId --output tsv)" \
...
```text frame="terminal" title="Create the Logic App"
az logic workflow create \
	--resource-group $RESOURCE_GROUP_NAME \
	--location $REGION \
	--name $LOGIC_APP_NAME \
...
```text frame="terminal" title="Setting the managedId and subscriptionId parameters"
az logic workflow update \
	--resource-group $RESOURCE_GROUP_NAME \
	--name $LOGIC_APP_NAME \
	--set "definition.parameters.managedId.defaultValue=$(az identity show --resource-group $RESOURCE_GROUP_NAME --name $MANAGED_ID_NAME --query id --output tsv)"
...
```text frame="terminal" title="Launching an Azure Application Gateway"
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-stop/01.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-stop/02.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-stop/03.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-stop/04.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-stop/05.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-start/01.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-start/02.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-start/03.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-start/04.png" },
      { src: "/assets/2024-04-01-saving-money-with-azure-logic-apps/images/agw-running-the-logic-app-start/05.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
```bash frame="terminal" title="Removing the demo Virtual Machines and Group"
export RESOURCE_GROUP_NAME="rg-demo-appgw-uks"
az group delete --name $RESOURCE_GROUP_NAME
```
...
<Img src="/assets/2024-04-01-saving-money-with-azure-logic-apps/images/working-through-the-logic-app/agw-full-logic-app.png" alt="The full machine workflow" />
...
<Img src="/assets/2024-04-01-saving-money-with-azure-logic-apps/images/working-through-the-logic-app/agw-results.png" alt="The full Application Gateway workflow" />
...
<Audio mp3="/assets/2024-04-01-saving-money-with-azure-logic-apps/2024-04-01-saving-money-with-azure-logic-apps.mp3" />
