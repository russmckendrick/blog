...
cover:
  image: "../../assets/2018-01-28-playing-with-rancher-2.0/blog-cover-2018-01-28-playing-with-rancher-2.0.png"
tags:
  - "Kubernetes"
  - "Cloud"
aliases:
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_1.png" alt="graphical user interface, website" />
...
```bash frame="terminal" title="Playing with Rancher 2.0 1/7"
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_2.png" alt="text" />

I checked that the container was up and running by running;

```bash frame="terminal" title="Playing with Rancher 2.0 2/7"
$ docker container ls
```


<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_3.png" alt="graphical user interface, text" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_4.png" alt="a screenshot of a computer" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_5.png" alt="graphical user interface" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_6.png" alt="graphical user interface, diagram" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_7.png" alt="graphical user interface, application, website" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_8.gif" alt="a group of people playing musical instruments" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_9.png" alt="graphical user interface, text, application, email" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_10.png" alt="graphical user interface, application" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_11.png" alt="graphical user interface, application" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_12.png" alt="graphical user interface, text, application, email" />

After a few minutes the cluster showed as Active in Rancher;

<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_13.png" alt="graphical user interface, application" />

Clicking on Nodes in the top menu showed me my three nodes;

<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_14.png" alt="graphical user interface" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_15.png" alt="graphical user interface, application" />

Clicking **Namespaces** showed me the namespaces I would expect to see in a newly launched Kubernetes cluster;

<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_16.png" alt="graphical user interface, text, application, email" />

Clicking **Nodes**, and then on one of the three nodes gave quite a detailed overview of the selected node;

<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_17.png" alt="graphical user interface, application" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_18.png" alt="graphical user interface, text, application, email" />
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_19.png" alt="graphical user interface, diagram, engineering drawing" />
...
```bash frame="terminal" title="Playing with Rancher 2.0 3/7"
...
```bash frame="terminal" title="Playing with Rancher 2.0 4/7"
...
```bash frame="terminal" title="Playing with Rancher 2.0 5/7"
...
```bash frame="terminal" title="Playing with Rancher 2.0 6/7"
...
```bash frame="terminal" title="Playing with Rancher 2.0 7/7"
$ docker container run -d \
    --restart=unless-stopped \
    -p 80:80 \
    -p 443:443 \
...
<Img src="/assets/2018-01-28-playing-with-rancher-2.0/img/2018-01-28_playing-with-rancher-2.0_20.png" alt="graphical user interface, application" />
