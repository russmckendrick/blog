...
```yaml title="Checkov - Scan Terraform files"
  - stage: "runCheckov"
...
```yaml title="Terraform - Auto Approval"
  - stage: "autoTerraform"
...
```yaml title="Terraform - Manual Approval"
