...
date: 2021-06-08
cover:
  image: "../../assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/blog-cover-2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals.png"
draft: false
showToc: true
tags:
  - "Terraform"
...
<Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/azure-devops-terraform-pipeline-01.svg" alt="Overview of the entire workflow" />
...
```bash frame="terminal" title="Checkov - Scan Terraform files"
``` yaml
  - stage: "runCheckov"
...
```bash frame="terminal" title="Run Checkov locally"
``` terminfo
docker run \
    --volume $(pwd):/tf \
    bridgecrew/checkov \
...
```bash frame="terminal" title="Terraform - Validate"
``` yaml
...
```bash frame="terminal" title="Terraform - Plan"
``` yaml
  - stage: "planTerraform"
...
```bash frame="terminal" title="condition"
``` yaml
condition: |
and
(
...
```bash frame="terminal" title="echo"
``` bash
echo "##vso[task.setvariable variable=HAS_CHANGES_ONLY;isOutput=true]true"
```
```
...
```bash frame="terminal" title="dependencies"
``` yaml
...
```bash frame="terminal" title="Terraform - Auto Approval"
``` yaml
  - stage: "autoTerraform"
...
```bash frame="terminal" title="Terraform - Manual Approval"
``` yaml
...
```bash frame="terminal" title="main.tf"
``` hcl
...
<Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf01.png" alt="Pipeline results" />

The two screens below show the warnings;

{/* Old gallery removed - please add images manually if needed */}
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf02.png" alt="warnings" />
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf03.png" alt="warnings" />
...
<Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf04.png" alt="No changes" />
...
```bash frame="terminal" title="Bad main.tf"
``` hcl
...
<Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf05.png" alt="Its failed!!!" />

Whoops, the Checkov stage failed, clicking on **Tests** should give us more information as to why;

<Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf06.png" alt="Checking why" />

Clicking on either the two results will give a more information;

{/* Old gallery removed - please add images manually if needed */}
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf07.png" alt="more info" />
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf08.png" alt="more info" />
{/* TODO: End shortcode: {{/oldgallery}} */}
...
{/* Old gallery removed - please add images manually if needed */}
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf09.png" />
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf10.png" />
{/* TODO: End shortcode: {{/oldgallery}} */}
...
<Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf11.png" alt="an email" />
...
{/* Old gallery removed - please add images manually if needed */}
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf12.png" alt="reviewing the change" />
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf13.png" alt="reviewing the change" />
   <Img src="/assets/2021-06-08-azure-devops-terraform-pipeline-with-checkov-approvals/images/tf14.png" alt="reviewing the change" />
{/* TODO: End shortcode: {{/oldgallery}} */}
