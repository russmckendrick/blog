...
cover:
  image: "../../assets/2015-07-22-adding-a-ssh-key-to-azure/blog-cover-2015-07-22-adding-a-ssh-key-to-azure.png"
tags:
  - "Azure"
  - "Security"
aliases:
...
```bash frame="terminal" title="Adding a SSH Key to Azure 1/1"
...
<Img src="/assets/2015-07-22-adding-a-ssh-key-to-azure/img/2015-07-22_adding-a-ssh-key-to-azure_1.png" alt="a screenshot of a computer" /><Img src="/assets/2015-07-22-adding-a-ssh-key-to-azure/img/2015-07-22_adding-a-ssh-key-to-azure_2.png" alt="graphical user interface, text, application" /><Img src="/assets/2015-07-22-adding-a-ssh-key-to-azure/img/2015-07-22_adding-a-ssh-key-to-azure_3.png" alt="graphical user interface" />
