...
cover:
  image: "../../assets/2015-12-20-jenkins/blog-cover-2015-12-20-jenkins.png"
tags:
  - "Linux"
  - "Automation"
  - "DevOps"
...
```bash frame="terminal" title="Jenkins 1/7"
...
```bash frame="terminal" title="Jenkins 2/7"
...
```bash frame="terminal" title="Jenkins 3/7"
server {
 listen 80;
...
```bash frame="terminal" title="Jenkins 4/7"
cd /root/
...
```bash frame="terminal" title="Jenkins 5/7"
...
```bash frame="terminal" title="Jenkins 6/7"
...
```bash frame="terminal" title="Jenkins 7/7"
