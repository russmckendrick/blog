...
cover:
  image: "../../assets/2016-12-29-portainer-a-ui-for-docker/blog-cover-2016-12-29-portainer-a-ui-for-docker.png"
tags:
  - "Docker"
  - "DevOps"
  - "Tools"
...
https://x.com/russmckendrick/status/812717388332351488
...
```bash frame="terminal" title="Portainer, a UI for Docker 1/12"
docker pull portainer/portainer
docker images
```


<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_1.png" alt="text" />
...
```bash frame="terminal" title="Portainer, a UI for Docker 2/12"
docker run -d -p 9000:9000 -v /var/run/docker.sock:/var/run/docker.sock portainer/portainer
```


<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_2.png" alt="text" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_3.png" alt="graphical user interface, application" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_4.png" alt="graphical user interface, application" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_5.png" alt="graphical user interface, text, application" />

Once connected you will be presented with a **Dashboard** which looks something like the following;

<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_6.png" alt="graphical user interface" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_7.png" alt="graphical user interface, application" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_8.png" alt="graphical user interface, application" />

Once the container has launched you will be shown a list of your running containers;

<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_9.png" alt="graphical user interface" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_10.png" alt="graphical user interface, application" />

Clicking on **Stats** will show you a real-time breakdown of what is happening within your container;

<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_11.png" alt="graphical user interface, application" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_12.png" alt="graphical user interface, text" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_13.png" alt="graphical user interface, text" />
...
```bash frame="terminal" title="Portainer, a UI for Docker 3/12"
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_14.png" alt="graphical user interface, table" />

Clicking on its name and then logs will show you the results of the Apache Bench run;

<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_15.png" alt="graphical user interface, text, application, email" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_16.png" alt="graphical user interface, application" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_17.png" alt="graphical user interface" />
...
```bash frame="terminal" title="Portainer, a UI for Docker 4/12"
...
```bash frame="terminal" title="Portainer, a UI for Docker 5/12"
docker-machine create \
  --driver digitalocean \
  --digitalocean-access-token your-do-token-goes-here \
  --digitalocean-region lon1 \
...
```bash frame="terminal" title="Portainer, a UI for Docker 6/12"
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_18.png" alt="text" />
...
```bash frame="terminal" title="Portainer, a UI for Docker 7/12"
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_19.png" alt="text" />

You can check that all three hosts are part of the Swarm cluster by running;

```bash frame="terminal" title="Portainer, a UI for Docker 8/12"
docker $(docker-machine config swmaster) node ls
```


<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_20.png" alt="a screenshot of a computer" />
...
```bash frame="terminal" title="Portainer, a UI for Docker 9/12"
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_21.png" alt="text, table" />

Now that we have the certificates we need to the IP address of the Docker Swarm Manager, to get this run the following;

```bash frame="terminal" title="Portainer, a UI for Docker 10/12"
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_22.png" alt="graphical user interface, application, email" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_23.png" alt="graphical user interface, application" />

As you can see, we have a few additional options. You can view information on your cluster by clicking on **Swarm**;

<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_24.png" alt="table" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_25.png" alt="graphical user interface, text, application, email" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_26.png" alt="graphical user interface, application" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_27.png" alt="graphical user interface" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_28.png" alt="graphical user interface, application" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_29.png" alt="graphical user interface, table" />

#### Teardown

Don’t forget to remove your Docker Swarm nodes once you have finished playing, you can do this by running;

```bash frame="terminal" title="Portainer, a UI for Docker 11/12"
...
```bash frame="terminal" title="Portainer, a UI for Docker 12/12"
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_30.png" alt="a screenshot of a computer" />
...
<Img src="/assets/2016-12-29-portainer-a-ui-for-docker/img/2016-12-29_portainer-a-ui-for-docker_31.png" alt="graphical user interface, text, application, email" />
