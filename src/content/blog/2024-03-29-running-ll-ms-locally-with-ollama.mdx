...
cover:
  image: "../../assets/2024-03-29-running-ll-ms-locally-with-ollama/blog-cover-2024-03-29-running-ll-ms-locally-with-ollama.png"
draft: false
showToc: true
tags:
  - "ai"
...
```bash frame="terminal" title="Installing the desktop version of ollama"
...
```bash frame="terminal" title="LInstalling the terminal version of ollama"
brew install ollama
```
...
```bash frame="terminal" title="Pulling llama2"
...
```bash frame="terminal" title="Opening a chat with llama2"
ollama run llama2
```
...
```bash frame="terminal" title="Chatting with llama2"
>>> Why is the sky blue?
...
```bash frame="terminal" title="Asking a question using cURL"
...
```bash frame="terminal" title="Download and chat with Mistral v0.2"
...
```bash frame="terminal" title="Pulling codellama"
...
{/* GALLERY: Directory not found: cover02.png */}
...
```bash frame="terminal" title="Sorting out a directory to store our data in"
...
```bash frame="terminal" title="Launching Open WebUI"
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/open-webui-01/01.png" },
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/open-webui-01/02.png" },
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/open-webui-01/03.png" },
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/open-webui-01/04.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/open-webui-02/01.png" },
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/open-webui-02/02.png" },
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/open-webui-02/03.png" },
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/open-webui-02/04.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
{/* GALLERY: Directory not found: images/open-webui-03 */}
...
<NoteCallout title="Mistral:Latest">
...
<WarningCallout title="Llama2:Latest">
...
{/* GALLERY: Directory not found: one-more-thing.png */}
...
```bash frame="terminal" title="ngrok is up and running"
ngrok http 3000
```
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/ngrok/01.png" },
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/ngrok/02.png" },
      { src: "/assets/2024-03-29-running-ll-ms-locally-with-ollama/images/ngrok/03.png" },
    ],
  }}
  options={{
    thumbnail: true,
