...
description: "Using Nano Banana Pro for generating stunning AI-powered album cover collages with intelligent image selection and content policy handling"
...
Enter **[Nano Banana Pro](https://blog.google/technology/ai/nano-banana-pro/)**, Googles latest image editing model:

<YouTube id="UQsJIo46ZR8" />
<br />

It is now available on the [FAL.ai](https://fal.ai/) API and after implementing this I now have a sophisticated AI-powered collage generator that intelligently selects the most vibrant album covers, analyzes them with GPT-4 Vision, and composites them into quirky music masterpieces.
...
Some albums are persistent offenders (I'm looking at you, [*Is This It*](https://russ.fm/album/is-this-it-3146367) and [*Með Suð Í Eyrum Við Spilum Endalaust*](https://russ.fm/album/med-sud-i-eyrum-vid-spilum-endalaust-21139177)). The config file includes a blacklist:

```json title="Blacklist"
{
  "blacklist": {
    "albums": [
      "Is This It",
...
```javascript title="Model loading"
...
I tested with the post from [Nov 17, 2025 post](https://www.russ.cloud/2025/11/17/a-sonic-journey-through-euphoria-and-reflection-in-timeless-sounds/), which contained these albums:

<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2025-11-17-listened-to-this-week/albums/Zeitgeist.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/So-Here-We-Are-Best-Of-Doves.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/De-La-Soul-Is-Dead.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/The-Big-Lad-In-The-Windmill.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/Lost-in-the-Dream.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/Metropolis-Pt-2-Scenes-From-a-Memory.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/Best-of-1969-1974.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/Specials.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/A-Secret-Wish.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/Songs-from-the-Big-Chair.jpg" },
      { src: "/assets/2025-11-17-listened-to-this-week/albums/Stop-Making-Sense-Music-from-a-film-by-Jonathan-Demme-and-Talking-Heads.jpg" }
    ]
  }}
/>

As you can see from the output below and the covers above it certainly made the right choice for which 8 covers to use for the collage, it correctly skipped the all text [Stop Making Sense](https://www.russ.fm/album/stop-making-sense-music-from-a-film-by-jonathan-demme-and-talking-heads-27799152/), and the not very colorful [Songs from the Big Chair](https://www.russ.fm/album/songs-from-the-big-chair-124187) and [A Secret Wish]()https://www.russ.fm/album/a-secret-wish-35663980/) ....

```text frame="terminal" title="Running the script"
...
<Img src="/assets/2025-11-23-playing-with-nano-banana-pro/tunes-cover-2025-11-17-listened-to-this-week.png" alt="17/11/205" fullWidth="true" />
<br />
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2025-11-23-playing-with-nano-banana-pro/tunes-cover-2025-04-21-listened-to-this-week.png", alt: "21/04/205"},
      { src: "/assets/2025-11-23-playing-with-nano-banana-pro/tunes-cover-2025-05-19-listened-to-this-week.png", alt: "19/05/205"},
      { src: "/assets/2025-11-23-playing-with-nano-banana-pro/tunes-cover-2025-06-16-listened-to-this-week.png", alt: "16/06/205"},      
      { src: "/assets/2025-11-23-playing-with-nano-banana-pro/tunes-cover-2025-06-30-listened-to-this-week.png", alt: "30/06/205"},   
      { src: "/assets/2025-11-23-playing-with-nano-banana-pro/tunes-cover-2025-09-15-listened-to-this-week.png", alt: "15/09/205"},
      { src: "/assets/2025-11-23-playing-with-nano-banana-pro/tunes-cover-2025-10-20-listened-to-this-week.png", alt: "20/10/205"}
    ]
  }}
/>
...
- **Main script**: [scripts/fal-tunes-cover.js](https://github.com/russmckendrick/blog/blob/main/scripts/fal-tunes-cover.js)
- **Config**: [scripts/fal-collage-config.json](https://github.com/russmckendrick/blog/blob/main/scripts/fal-collage-config.json)
- **Tunes generator**: [scripts/generate-tunes-post.js (orchestrator)](https://github.com/russmckendrick/blog/blob/main/scripts/generate-tunes-post.js)
...
**Run manually:**
```bash
node scripts/fal-tunes-cover.js --input=./albums --output=./collage.png --debug
```
...
- [FAL.ai Nano Banana Pro Documentation](https://fal.ai/models/fal-ai/nano-banana-pro)
