...
cover:
  image: "../../assets/2014-12-02-grunt-jekyll-less/blog-cover-2014-12-02-grunt-jekyll-less.png"
tags:
  - "Code"
  - "Tools"
aliases:
...
```bash frame="terminal" title="Grunt + Jekyll + LESS 1/3"
brew install node
...
```bash frame="terminal" title="Grunt + Jekyll + LESS 2/3"
{
 “name”: “mediaglasses”,
 “version”: “0.0.1”,
...
```bash frame="terminal" title="Grunt + Jekyll + LESS 3/3"
