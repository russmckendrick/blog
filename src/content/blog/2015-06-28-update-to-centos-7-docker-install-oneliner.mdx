...
cover:
  image: "../../assets/2015-06-28-update-to-centos-7-docker-install-oneliner/blog-cover-2015-06-28-update-to-centos-7-docker-install-oneliner.png"
tags:
  - "Linux"
  - "Docker"
aliases:
...
```bash frame="terminal" title="Update to CentOS 7 Docker install one-liner 1/2"
...
<Img src="/assets/2015-06-28-update-to-centos-7-docker-install-oneliner/img/2015-06-28_update-to-centos-7-docker-install-oneliner_1.png" alt="asciicast" />

or run it using;

```bash frame="terminal" title="Update to CentOS 7 Docker install one-liner 2/2"
