...
cover:
  image: "../../assets/2014-05-31-openshift-origin-installation-notes/blog-cover-2014-05-31-openshift-origin-installation-notes.png"
tags:
  - "Linux"
  - "Automation"
  - "DevOps"
...
```bash frame="terminal" title="OpenShift Origin installation notes 1/2"
yum update -y
...
```bash frame="terminal" title="OpenShift Origin installation notes 2/2"
yum update -y
