...
cover:
  image: "../../assets/2014-12-06-more-grunt-jekyll/blog-cover-2014-12-06-more-grunt-jekyll.png"
tags:
  - "Code"
  - "Tools"
aliases:
...
```bash frame="terminal" title="More Grunt & Jekyll 1/7"
js: {
 src: [
...
```bash frame="terminal" title="More Grunt & Jekyll 2/7"
uglify: {
 options: {
...
```bash frame="terminal" title="More Grunt & Jekyll 3/7"
...
```bash frame="terminal" title="More Grunt & Jekyll 4/7"
imgcompress: {
 dist: {
 options: {
 optimizationLevel: 7,
...
```bash frame="terminal" title="More Grunt & Jekyll 5/7"
...
```bash frame="terminal" title="More Grunt & Jekyll 6/7"
...
```bash frame="terminal" title="More Grunt & Jekyll 7/7"
{
 “name”: “mediaglasses”,
 “version”: “0.0.1”,
