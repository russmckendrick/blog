...
cover:
  image: "../../assets/2016-08-12-docker-for-amazon-web-services-beta/blog-cover-2016-08-12-docker-for-amazon-web-services-beta.png"
tags:
  - "Cloud"
  - "AWS"
  - "Docker"
...
<Img src="/assets/2016-08-12-docker-for-amazon-web-services-beta/img/2016-08-12_docker-for-amazon-web-services-beta_1.jpg" alt="email" />
...
<Img src="/assets/2016-08-12-docker-for-amazon-web-services-beta/img/2016-08-12_docker-for-amazon-web-services-beta_2.jpg" alt="docker-aws02" />
...
<Img src="/assets/2016-08-12-docker-for-amazon-web-services-beta/img/2016-08-12_docker-for-amazon-web-services-beta_3.jpg" alt="docker-aws03" />
...
<Img src="/assets/2016-08-12-docker-for-amazon-web-services-beta/img/2016-08-12_docker-for-amazon-web-services-beta_4.jpg" alt="docker-aws04" />
...
```bash frame="terminal" title="Docker for Amazon Web Services Beta 1/7"
cat /etc/*release
```
...
```bash frame="terminal" title="Docker for Amazon Web Services Beta 2/7"
NAME=”Alpine Linux”
ID=alpine
VERSION_ID=3.3.3
...
<Img src="/assets/2016-08-12-docker-for-amazon-web-services-beta/img/2016-08-12_docker-for-amazon-web-services-beta_5.jpg" alt="docker-aws05" />
...
```bash frame="terminal" title="Docker for Amazon Web Services Beta 3/7"
docker node ls
...
```bash frame="terminal" title="Docker for Amazon Web Services Beta 4/7"
docker -v
...
```bash frame="terminal" title="Docker for Amazon Web Services Beta 5/7"
...
<Img src="/assets/2016-08-12-docker-for-amazon-web-services-beta/img/2016-08-12_docker-for-amazon-web-services-beta_6.jpg" alt="docker-aws07" />

As before we can scale the service using the following command …

```bash frame="terminal" title="Docker for Amazon Web Services Beta 6/7"
...
```bash frame="terminal" title="Docker for Amazon Web Services Beta 7/7"
docker service ls
...
<Img src="/assets/2016-08-12-docker-for-amazon-web-services-beta/img/2016-08-12_docker-for-amazon-web-services-beta_7.jpg" alt="docker-aws06" />
...
<Img src="/assets/2016-08-12-docker-for-amazon-web-services-beta/img/2016-08-12_docker-for-amazon-web-services-beta_8.jpg" alt="docker-aws08" />
