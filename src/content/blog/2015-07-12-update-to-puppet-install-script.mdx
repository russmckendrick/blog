...
cover:
  image: "../../assets/2015-07-12-update-to-puppet-install-script/blog-cover-2015-07-12-update-to-puppet-install-script.png"
tags:
  - "Automation"
  - "Linux"
  - "Tools"
...
```bash frame="terminal" title="Update to Puppet Install Script 1/2"
...
```bash frame="terminal" title="Update to Puppet Install Script 2/2"
