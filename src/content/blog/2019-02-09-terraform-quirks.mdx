...
cover:
  image: "../../assets/2019-02-09-terraform-quirks/blog-cover-2019-02-09-terraform-quirks.png"
tags:
  - "Terraform"
...
```bash frame="terminal" title="Terraform Quirks 1/4"
...
```bash frame="terminal" title="Terraform Quirks 2/4"
...
```bash frame="terminal" title="Terraform Quirks 3/4"
...
```bash frame="terminal" title="Terraform Quirks 4/4"
