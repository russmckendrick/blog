...
cover:
  image: "../../assets/2021-09-05-docker-desktop-alternatives-for-macos/blog-cover-2021-09-05-docker-desktop-alternatives-for-macos.png"
draft: false
showToc: true
tags:
  - "Docker"
...
https://x.com/russmckendrick/status/1432739340266913797
...
```bash frame="terminal" title="Installing and starting Lima"
``` awk
brew install lima
limactl start
```
...
```bash frame="terminal" title="uname -a"
``` awk
lima uname -a
```
```
...
```bash frame="terminal" title="Running the Docker hello-world"
``` awk
...
```bash frame="terminal" title="The Dockerfile"
``` dockerfile
FROM alpine:latest
...
```bash frame="terminal" title="Running a container from our image"
``` awk
...
<Img src="/assets/2021-09-05-docker-desktop-alternatives-for-macos/images/01.png" alt="We're no strangers to love, You know the rules and so do I" />
...
```bash frame="terminal" title="List all containers"
``` plaintext
...
```bash frame="terminal" title="List all images"
``` plaintext
...
```bash frame="terminal" title="Stop and remove NGINX container"
``` awk
...
```bash frame="terminal" title="Stop and remove Lima VM"
``` awk
limactl stop
...
<Img src="/assets/2021-09-05-docker-desktop-alternatives-for-macos/images/02.png" alt="General" />

The other options look like the following (click to zoom):

{/* Old gallery removed - please add images manually if needed */}
<Img src="/assets/2021-09-05-docker-desktop-alternatives-for-macos/images/03.png" alt="Kubernetes Settings" />
<Img src="/assets/2021-09-05-docker-desktop-alternatives-for-macos/images/04.png" alt="Port Forwarding" />
<Img src="/assets/2021-09-05-docker-desktop-alternatives-for-macos/images/05.png" alt="Images" />
<Img src="/assets/2021-09-05-docker-desktop-alternatives-for-macos/images/06.png" alt="Troubleshooting" />
...
```bash frame="terminal" title="List the nodes"
``` awk
kubectl get nodes
```
```
...
```bash frame="terminal" title="Install a helm chart"
``` awk
...
```bash frame="terminal" title="Install a minikube, kubectl and helm"
``` awk
...
```bash frame="terminal" title="Open a tunnel to the cluster"
``` awk
minikube tunnel
```
```
...
<Img src="/assets/2021-09-05-docker-desktop-alternatives-for-macos/images/07.png" alt="K8s Hello World" />

### Tidying up

Like Lima, Minikube will continue to run in the background until it is stopped, which you can do by running:

```bash frame="terminal" title="Stopping"
minikube stop
...
```bash frame="terminal" title="Deleting"
minikube delete
