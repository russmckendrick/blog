...
cover:
  image: "../../assets/2016-06-25-docker-load-balancing-application-bundles/blog-cover-2016-06-25-docker-load-balancing-application-bundles.png"
tags:
  - "Docker"
aliases:
...
<Img src="/assets/2016-06-25-docker-load-balancing-application-bundles/img/2016-06-25_docker-load-balancing-application-bundles_1.png" alt="asciicast" />

Once complete, you should have four droplets launched in [Digital Ocean](https://m.do.co/c/52ec4dc3647e);

<Img src="/assets/2016-06-25-docker-load-balancing-application-bundles/img/2016-06-25_docker-load-balancing-application-bundles_2.jpg" alt="more-docker-service01" />
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 1/13"
docker node ls
```
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 2/13"
...
<Img src="/assets/2016-06-25-docker-load-balancing-application-bundles/img/2016-06-25_docker-load-balancing-application-bundles_3.jpg" alt="more-docker-service02" />
...
<Img src="/assets/2016-06-25-docker-load-balancing-application-bundles/img/2016-06-25_docker-load-balancing-application-bundles_4.jpg" alt="more-docker-service03" />
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 3/13"
docker service scale cluster=15
docker service tasks cluster
```


<Img src="/assets/2016-06-25-docker-load-balancing-application-bundles/img/2016-06-25_docker-load-balancing-application-bundles_5.jpg" alt="more-docker-service04" />

Before looking at anything else lets remove the cluster service;

```bash frame="terminal" title="Docker Load Balancing & Application Bundles 4/13"
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 5/13"
version: ‘2’
services:
 wordpress:
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 6/13"
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 7/13"
mkdir ~/Desktop/test
cd ~/Desktop/test
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 8/13"
docker-compose pull
```
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 9/13"
docker-compose bundle -o wordpress.dsb
```


<Img src="/assets/2016-06-25-docker-load-balancing-application-bundles/img/2016-06-25_docker-load-balancing-application-bundles_6.jpg" alt="more-docker-service06" />

a copy of the bundle created above looks like;

```bash frame="terminal" title="Docker Load Balancing & Application Bundles 10/13"
<!DOCTYPE html>
...
<meta name="enabled-homepage-translation-languages" content="" />
  ...
  <body class="logged-out env-production page-responsive" style="word-wrap: break-word;">
    ...
    <div class="position-relative js-header-wrapper ">
      <a href="/assets/2016-06-25-docker-load-balancing-application-bundles/#start-of-content" class="px-2 py-4 color-bg-info-inverse color-text-white show-on-focus js-skip-to-content">Skip to content</a>
...
<div class="container-lg px-3 new-discussion-timeline">
  ...
  Raw
        ...
        <div class="file-info pr-4 d-flex flex-md-items-center flex-items-start flex-order-1 flex-auto">
          ...
          <a class="wb-break-all" href="/assets/2016-06-25-docker-load-balancing-application-bundles/#file-docker-compose-yml">
...
<table class="highlight tab-size js-file-line-container" data-tab-size="8" data-paste-markdown-skip>
  ...
  Raw
        ...
        <div class="file-info pr-4 d-flex flex-md-items-center flex-items-start flex-order-1 flex-auto">
          ...
          <a class="wb-break-all" href="/assets/2016-06-25-docker-load-balancing-application-bundles/#file-wordpress-dsb">
            <strong class="user-select-contain gist-blob-name css-truncate-target">
              wordpress.dsb
            </strong>
          </a>
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 11/13"
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 12/13"
...
```bash frame="terminal" title="Docker Load Balancing & Application Bundles 13/13"
...
<Img src="/assets/2016-06-25-docker-load-balancing-application-bundles/img/2016-06-25_docker-load-balancing-application-bundles_7.jpg" alt="more-docker-service07" />
...
<Img src="/assets/2016-06-25-docker-load-balancing-application-bundles/img/2016-06-25_docker-load-balancing-application-bundles_8.png" alt="asciicast" />
