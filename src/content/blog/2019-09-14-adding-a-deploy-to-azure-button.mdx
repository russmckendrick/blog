...
cover:
  image: "../../assets/2019-09-14-adding-a-deploy-to-azure-button/blog-cover-2019-09-14-adding-a-deploy-to-azure-button.png"
tags:
  - "Azure"
  - "Automation"
aliases:
...
<Img src="/assets/2019-09-14-adding-a-deploy-to-azure-button/img/2019-09-14_adding-a-deploy-to-azure-button_1.png" alt="" />
...
```bash frame="terminal" title="Adding a Deploy to Azure Button 1/1"
...
<Img src="/assets/2019-09-14-adding-a-deploy-to-azure-button/img/2019-09-14_adding-a-deploy-to-azure-button_2.png" alt="a screenshot of a computer" />
...
<Img src="/assets/2019-09-14-adding-a-deploy-to-azure-button/img/2019-09-14_adding-a-deploy-to-azure-button_3.png" alt="a screenshot of a computer" />
...
<Img src="/assets/2019-09-14-adding-a-deploy-to-azure-button/img/2019-09-14_adding-a-deploy-to-azure-button_4.png" alt="a screenshot of a computer" />

This is a nice and simple way to allow your users to launch your ARM template powered application in Azure ☁️.

<Img src="/assets/2019-09-14-adding-a-deploy-to-azure-button/img/2019-09-14_adding-a-deploy-to-azure-button_5.gif" alt="a man in a blue shirt" />
