...
cover:
  image: "../../assets/2016-02-27-consul-docker-cluster/blog-cover-2016-02-27-consul-docker-cluster.png"
tags:
  - "Automation"
  - "Docker"
  - "Tools"
...
```bash frame="terminal" title="Consul Docker Cluster 1/10"
...
```bash frame="terminal" title="Consul Docker Cluster 2/10"
...
```bash frame="terminal" title="Consul Docker Cluster 3/10"
...
```bash frame="terminal" title="Consul Docker Cluster 4/10"
...
```bash frame="terminal" title="Consul Docker Cluster 5/10"
...
```bash frame="terminal" title="Consul Docker Cluster 6/10"
...
```bash frame="terminal" title="Consul Docker Cluster 7/10"
...
```bash frame="terminal" title="Consul Docker Cluster 8/10"
...
```bash frame="terminal" title="Consul Docker Cluster 9/10"
...
```bash frame="terminal" title="Consul Docker Cluster 10/10"
...
<Img src="/assets/2016-02-27-consul-docker-cluster/img/2016-02-27_consul-docker-cluster_1.png" alt="consul" />
