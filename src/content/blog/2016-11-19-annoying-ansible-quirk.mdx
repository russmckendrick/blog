...
cover:
  image: "../../assets/2016-11-19-annoying-ansible-quirk/blog-cover-2016-11-19-annoying-ansible-quirk.png"
tags:
  - "Ansible"
  - "AWS"
aliases:
...
```bash frame="terminal" title="Annoying Ansible Quirk 1/5"
pre_tasks:
...
```bash frame="terminal" title="Annoying Ansible Quirk 2/5"
...
```bash frame="terminal" title="Annoying Ansible Quirk 3/5"
...
```bash frame="terminal" title="Annoying Ansible Quirk 4/5"
pre_tasks:
  - yum: name=python-setuptools state=installed
tags:
  - always
...
```bash frame="terminal" title="Annoying Ansible Quirk 5/5"
ansible-playbook -i hosts stage-launch.yml — skip-tags “morning” — extra-vars “ami_name=$(date +%Y-%m-%d-%H%M)” — ask-vault-pass
```
