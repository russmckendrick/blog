...
cover:
  image: "../../assets/2016-09-11-amazon-web-services-with-ansible/blog-cover-2016-09-11-amazon-web-services-with-ansible.png"
tags:
...
```bash frame="terminal" title="Amazon Web Services with Ansible 1/9"
subnet_elb:
...
```bash frame="terminal" title="Amazon Web Services with Ansible 2/9"
...
```bash frame="terminal" title="Amazon Web Services with Ansible 3/9"
...
```bash frame="terminal" title="Amazon Web Services with Ansible 4/9"
firewall_elb:
...
```bash frame="terminal" title="Amazon Web Services with Ansible 5/9"
firewall_elb:
 — proto: tcp
   from_port: 443
   to_port: 443
...
```bash frame="terminal" title="Amazon Web Services with Ansible 6/9"
...
```bash frame="terminal" title="Amazon Web Services with Ansible 7/9"
...
```bash frame="terminal" title="Amazon Web Services with Ansible 8/9"
...
```bash frame="terminal" title="Amazon Web Services with Ansible 9/9"
