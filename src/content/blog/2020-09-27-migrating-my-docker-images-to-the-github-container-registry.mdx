...
date: 2020-09-27
cover:
  image: "../../assets/2020-09-27-migrating-my-docker-images-to-the-github-container-registry/blog-cover-2020-09-27-migrating-my-docker-images-to-the-github-container-registry.png"
tags:
  - "Docker"
  - "Github"
aliases:
...
```docker frame="terminal" title="Dockerfile"
### Dockerfile
#
...
```yaml frame="terminal" title="Github Action"
name: ab
on:
  push:
    branches: master
...
```bash frame="terminal" title="Github Action"
``` yaml
name: ab
```
```
...
<Img src="/assets/2020-09-27-migrating-my-docker-images-to-the-github-container-registry/images/01.png" alt="graphical user interface, text" />

Once pushed I was able to run Apache Bench by running the following commands:

```bash frame="terminal" title="Docker"
``` bash
...
<Img src="/assets/2020-09-27-migrating-my-docker-images-to-the-github-container-registry/images/02.png" alt="text" />
...
<Img src="/assets/2020-09-27-migrating-my-docker-images-to-the-github-container-registry/images/03.png" alt="diagram" />
