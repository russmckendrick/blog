...
cover:
  image: "../../assets/2024-04-06-effortless-python-environment-management-on-mac-os-with-conda/blog-cover-2024-04-06-effortless-python-environment-management-on-mac-os-with-conda.png"
draft: false
showToc: true
avatar: "hoodie-up"
tags:
...
```text frame="terminal" title="Installing Miniconda"
...
```text frame="terminal" title="Update the ~/.zshrc file"
conda init zsh
```
...
```text frame="code" title="Contents appended to ~/.zshrc (TEXT)" showLineNumbers
# >>> conda initialize >>>
...
{/* GALLERY: Directory not found: images/my-terminal-prompt.png */}
...
```text frame="terminal" title="Creating the Ansible environment"
...
```text frame="terminal" title="Output of the create command"
Channels:
 - defaults
Platform: osx-arm64
...
```text frame="terminal" title="Activating the Ansible environment"
conda activate ansible
```
...
```text frame="terminal" title="Checking which python is being used"
which python
...
```text frame="terminal" title="Installing Ansible and some collections"
...
{/* GALLERY: Directory not found: images/the-ansbile-env.png */}
...
```text frame="terminal" title="Installing Ansible using pip"
python -m pip install ansible
```
...
```text frame="terminal" title="The Conda install command"
...
```text frame="terminal" title="Going through the installation"
Channels:
 - defaults
 - conda-forge
Platform: osx-arm64
...
```text frame="code" title="Installing Python 3.10 (TEXT)"
...
```text frame="terminal" title="Installing Python 3.10"
...
```text frame="terminal" title="The output of installing Python 3.10"
Channels:
 - defaults
Platform: osx-arm64
Collecting package metadata (repodata.json): done
...
{/* GALLERY: Directory not found: images/different-python-versions.png */}

### Managing Virtual Environments

You can list all of your virtual environments using the command below:

```text frame="terminal" title="Listing all envs"
conda env list
```
...
```text frame="terminal" title="The output of conda env list"
# conda environments:
#
...
```text frame="terminal" title="Removing the test env"
...
```text frame="terminal" title="The output of conda remove -n test --all"
...
```text frame="terminal" title="Updating the Conda managed packages in your env"
conda update --all
```
