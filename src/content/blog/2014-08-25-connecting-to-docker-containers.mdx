...
cover:
  image: "../../assets/2014-08-25-connecting-to-docker-containers/blog-cover-2014-08-25-connecting-to-docker-containers.png"
tags:
  - "Docker"
  - "Tools"
aliases:
...
```bash frame="terminal" title="Connecting to Docker Containers 1/2"
...
```bash frame="terminal" title="Connecting to Docker Containers 2/2"
