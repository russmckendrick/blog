...
cover:
  image: "../../assets/2024-06-28-azure-devops-ansible-pipeline-updated/blog-cover-2024-06-28-azure-devops-ansible-pipeline-updated.png"
draft: false
showToc: true
avatar: "hoodie-up"
tags:
...
<LinkPreview id="https://github.com/PacktPublishing/Learn-Ansible-Second-Edition/blob/main/Chapter15/azure-pipelines.yml" />
...
```yaml frame="code" title="The Variables (YAML)" showLineNumbers
...
```yaml frame="code" title="Set up the virtual environment (YAML)" showLineNumbers
- task: Bash@3
...
```yaml frame="code" title="Check if there is an active cache (YAML)" showLineNumbers
- task: Cache@2
  name: "cache_venv"
...
```yaml frame="code" title="Install the requirements if there is no active cache (YAML)" showLineNumbers
- task: Bash@3
...
```yaml frame="code" title="Run the Ansible Playbook (YAML)" showLineNumbers
 - task: Bash@3
   name: "ansible"
...
<LightGallery
  layout={{
    imgs: [
      { src: "/assets/2024-06-28-azure-devops-ansible-pipeline-updated/images/cache/01-no-cache-overview.png" },
      { src: "/assets/2024-06-28-azure-devops-ansible-pipeline-updated/images/cache/02-cache-miss.png" },
      { src: "/assets/2024-06-28-azure-devops-ansible-pipeline-updated/images/cache/03-Install Dependencies.png" },
      { src: "/assets/2024-06-28-azure-devops-ansible-pipeline-updated/images/cache/04-cache-run.png" },
      { src: "/assets/2024-06-28-azure-devops-ansible-pipeline-updated/images/cache/05-cache-hit.png" },
      { src: "/assets/2024-06-28-azure-devops-ansible-pipeline-updated/images/cache/06-Install Dependencies-Skipped.png" },
      { src: "/assets/2024-06-28-azure-devops-ansible-pipeline-updated/images/cache/07-side-by-side.png" },
    ],
  }}
  options={{
    thumbnail: true,
...
<LinkPreview id="https://github.com/russmckendrick/DevOpsAnsiblePipeline2024" />

## Further reading and links

You can buy the second edition of Learn Ansible from the link below:

<LinkPreview id="https://www.packtpub.com/en-gb/product/learn-ansible-9781835088913" />

Read the original blog post here:

<LinkPreview id="https://www.russ.cloud/2020/05/10/azure-devops-ansible-pipeline/" />

Find out more on the `Cache@2` task at:

<LinkPreview id="https://learn.microsoft.com/en-us/azure/devops/pipelines/tasks/reference/cache-v2?view=azure-pipelines" />
...
<Audio mp3="/assets/2024-06-28-azure-devops-ansible-pipeline-updated/2024-06-28-azure-devops-ansible-pipeline-updated.mp3" />
