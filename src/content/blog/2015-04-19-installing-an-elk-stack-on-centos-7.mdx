...
cover:
  image: "../../assets/2015-04-19-installing-an-elk-stack-on-centos-7/blog-cover-2015-04-19-installing-an-elk-stack-on-centos-7.png"
tags:
  - "Tools"
  - "Linux"
aliases:
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 1/11"
 cd /opt
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 2/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 3/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 4/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 5/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 6/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 7/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 8/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 9/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 10/11"
...
```bash frame="terminal" title="Installing an ELK Stack on CentOS 7 11/11"
...
<Img src="/assets/2015-04-19-installing-an-elk-stack-on-centos-7/img/2015-04-19_installing-an-elk-stack-on-centos-7_1.png" alt="discover-kibana-4" />
