...
Describe what you need in natural language, and Cowork creates a plan, loads the relevant skills, and works through the task step by step. It shows what it's doing at each stage and asks for approval before taking irreversible actions, such as sending an email or posting on Teams.
