...
cover:
  image: "../../assets/2017-09-24-ansible-awx/blog-cover-2017-09-24-ansible-awx.png"
tags:
  - "DevOps"
  - "Ansible"
  - "Linux"
...
```bash frame="terminal" title="Ansible AWX 1/3"
# -*- mode: ruby -*-
# vi: set ft=ruby :
...
```bash frame="terminal" title="Ansible AWX 2/3"
- name: Deploy AWX
  hosts: all
  become: true
  become_user: root
...
<Img src="/assets/2017-09-24-ansible-awx/img/2017-09-24_ansible-awx_1.png" alt="text" />
...
```bash frame="terminal" title="Ansible AWX 3/3"
vagrant ssh
...
<Img src="/assets/2017-09-24-ansible-awx/img/2017-09-24_ansible-awx_2.png" alt="text" />

Also, you should have several containers running;

<Img src="/assets/2017-09-24-ansible-awx/img/2017-09-24_ansible-awx_3.png" alt="text" />

Once the containers have launched, going to [http://localhost:8080/](http://localhost:8080/) should show you the following;

<Img src="/assets/2017-09-24-ansible-awx/img/2017-09-24_ansible-awx_4.png" alt="graphical user interface, text" />
...
<Img src="/assets/2017-09-24-ansible-awx/img/2017-09-24_ansible-awx_5.png" alt="graphical user interface" />
...
<Img src="/assets/2017-09-24-ansible-awx/img/2017-09-24_ansible-awx_6.png" alt="graphical user interface, text, application" />
