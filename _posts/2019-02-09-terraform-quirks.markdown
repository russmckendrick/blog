...
comments: true
date: 2019-02-09 19:11:25+00:00
excerpt: A post about some of my bug bears with the current version of Terraform. Don't worry, they will all be fixed soon.
layout: post
current: post
class: post-template
navigation: True
link: 2019/02/09/terraform-quirks/
slug: terraform-quirks
title: Terraform Quirks
cover: assets/posts/terraform-update.png
categories: Tech
tags: 
  - Azure
  - Terraform
...
No problem I thought to myself - I remembered from the last time I used  Terraform that there are resource dependencies in the form of  **[depends_on](https://learn.hashicorp.com/terraform/getting-started/dependencies.html)**. However, after much reading, I discovered that **depends_on** isn't yet supported for modules - it is on the road map though.
...
Or the following blog posts from Hashicorp which go to make up a [preview of Terraform 0.12](https://www.hashicorp.com/blog/terraform-0-1-2-preview);  
  ...
  * [Conditional Operator Improvements and Conditionally Omitted Arguments](https://www.hashicorp.com/blog/terraform-0-12-conditional-operator-improvements)
  * [Rich Value Types](https://www.hashicorp.com/blog/terraform-0-12-rich-value-types)
  * [Template Syntax](https://www.hashicorp.com/blog/terraform-0-12-template-syntax)
  * [Reliable JSON Syntax](https://www.hashicorp.com/blog/terraform-0-12-reliable-json-syntax)
