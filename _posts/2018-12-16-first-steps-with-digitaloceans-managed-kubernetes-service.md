...
comments: true
date: 2018-12-16 17:58:12+00:00
excerpt: I had a play with DigitalOcean's new Managed Kubernetes service.
layout: post
current: post
class: post-template
cover: assets/posts/kube-do.png
link: http://mediaglasses.blog/2018/12/16/first-steps-with-digitaloceans-managed-kubernetes-service/
slug: first-steps-with-digitaloceans-managed-kubernetes-service
