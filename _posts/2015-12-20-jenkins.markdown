...
comments: true
date: 2015-12-20 18:10:26+00:00
layout: post
current: post
class: post-template
cover: assets/posts/jenkins.png
link: http://mediaglasses.blog/2015/12/20/jenkins/
slug: jenkins
title: Jenkins
wordpress_id: 1064
categories:
...
Once I had that in order I grabbed the repo file for the Jenkins RPM repository and installed the package along with Java and NGINX;
    ...
    wget -O /etc/yum.repos.d/jenkins.repo <a href="http://pkg.jenkins-ci.org/redhat/jenkins.repo" target="_blank" data-href="http://pkg.jenkins-ci.org/redhat/jenkins.repo">http://pkg.jenkins-ci.org/redhat/jenkins.repo</a>
    rpm — import <a href="http://pkg.jenkins-ci.org/redhat/jenkins-ci.org.key" target="_blank" data-href="http://pkg.jenkins-ci.org/redhat/jenkins-ci.org.key">http://pkg.jenkins-ci.org/redhat/jenkins-ci.org.key</a>
...
The NGINX config file which was called /etc/nginx/conf.d/jenkins.conf looks like this;
    ...
    server {
     ...
     return 301 <a href="https://%24host%24request_uri;" target="_blank" data-href="https://$host$request_uri;">https://$host$request_uri;</a>
    }
    ...
    auth_basic “Restricted”;
     ...
     proxy_redirect <a href="http://localhost:8080" target="_blank" data-href="http://localhost:8080">http://localhost:8080</a> <a href="https://jenkins.super-awesome-domain.io;" target="_blank" data-href="https://jenkins.super-awesome-domain.io;">https://jenkins.super-awesome-domain.io;</a>
     }
     }
...
As you have noticed I got the certificate from the incredibly awesome [LetEncrypt](https://letsencrypt.org). As the domain I was using was already resolving to the server getting the certificate was a simple as running the following commands and then following the on screen prompts;
    ...
    cd /root/
    git clone <a href="https://github.com/letsencrypt/letsencrypt" target="_blank" data-href="https://github.com/letsencrypt/letsencrypt">https://github.com/letsencrypt/letsencrypt</a>
    cd letsencrypt/
