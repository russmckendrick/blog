...
image: assets/posts/hackers2.png
...
Now it’s time to start [firewalld](https://fedoraproject.org/wiki/FirewallD) & fail2ban;
...
or you can check for errors using [journalctl](http://www.freedesktop.org/software/systemd/man/journalctl.html);
