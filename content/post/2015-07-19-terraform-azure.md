...
image: assets/posts/terraform.png
...
As regular readers will know I really like the tools provided by [Hashicorp](https://hashicorp.com/) and today I found an excuse to use one. I needed to bring up a Virtual Machine in [Microsoft Azure](http://azure.microsoft.com/en-gb/). I hadn’t logged into Azure for quite a while so imagine my shock when I opened the dashboard, it’s not that great and the beta of the new one isn’t that brilliant either. It was so bad I tweeted about it ….

[embed]https://twitter.com/mediaglasses/status/622503853162934273[/embed]

I had recently looked at [Terraform](https://www.terraform.io) for another project and I worked through the [excellent getting started guide which covers how to launch AWS Instances](https://www.terraform.io/intro/getting-started/install.html).
...
Terraform is straight forward to install if you have [Homebrew](http://brew.sh) installed, none Mac users can follow the [install guide](https://www.terraform.io/intro/getting-started/install.html).
...
There is a Cask version of terraform, this does not ship with the Azure provider so use the main brew package instead. [Graphviz](http://www.graphviz.org) is installed so that the graph functionality can be used.
...
![graph](https://cdn-images-1.medium.com/max/800/0*nulj5u2b88cVAIQM.png)
...
![microsoft-azure](https://cdn-images-1.medium.com/max/800/0*cU2-foZsDVYhfwZh.png)
