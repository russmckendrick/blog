...
image: assets/posts/037d4-1ps5wkrhvianif6diuiqrjg.png
...
Also, the product is very much still in active development and there have been several bugs, [like this one](https://github.com/openshift/origin/issues/2245), which have caused the instructions below not to work.
...
I put my Vagrant machines in ~/Machines/ so first of lets create a directory in there so we can checkout the [latest release](https://github.com/openshift/origin/releases) and start the Vagrant machine;
    ...
    git clone — branch v0.5.2 <a href="https://github.com/openshift/origin.git" target="_blank" data-href="https://github.com/openshift/origin.git">https://github.com/openshift/origin.git</a> .
    vagrant up
    vagrant ssh
...
![openshift-management-console-60ad36a7618b4c47930043f7f1feb1c7](https://cdn-images-1.medium.com/max/800/0*P8taDR5mM09MQZsL.png)
...
[https://www.youtube.com/embed/1hDEe0_sk0o](https://www.youtube.com/embed/1hDEe0_sk0o)
