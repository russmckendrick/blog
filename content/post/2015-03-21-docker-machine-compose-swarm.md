...
image: assets/posts/56bb6-1fkvck8ohwoqaoqemnflprq.png
...
Since I last properly [wrote about Docker](https://media-glass.es/2014/08/31/docker-fig-reverse-proxy-centos7/) a lot has changed. Docker have introduced some new command line tools which allow for easy orchestration of Docker instances, clusters and container management. These are;
  ...
  * 
[Docker Machine](https://docs.docker.com/machine/) — Allows you to easily deploy Docker instances to a lot of different platforms.

 	
  * 
[Docker Compose](https://docs.docker.com/compose/) — A replacement for [Fig](https://fig.sh).

 	
  * 
[Docker Swarm](https://docs.docker.com/swarm/) — Native clustering for your Docker instances.
...
Rather than downloading the pre-compiled binary I decided to use the [Homebrew](http://brew.sh) formula (this assumes you have [Cask installed](https://media-glass.es/2014/10/20/yosemite-installation/));
...
I already have [VirtualBox](https://www.virtualbox.org) installed so lets create a machine called “Testing”;
...
As with any new installation, lets run a [“Hello World”](http://en.wikipedia.org/wiki/%22Hello,_World!%22_program);
...
Lets use docker-machine to launch a [Digital Ocean](https://www.digitalocean.com/?refcode=52ec4dc3647e) droplet. To do this you will need to generate a Personal Access Token, you can do this by [following these instructions](https://www.digitalocean.com/community/tutorials/how-to-use-the-digitalocean-api-v2). Once have the token launch the droplet as follows;
...
_(and no, that is not my Digital Ocean Personal Access Token, it’s just a random string)_
...
and finally SSH into the machine;
    ...
    Documentation: <a href="https://help.ubuntu.com/" target="_blank" data-href="https://help.ubuntu.com/">https://help.ubuntu.com/</a>
    ...
    <a href="https://landscape.canonical.com/" target="_blank" data-href="https://landscape.canonical.com/">https://landscape.canonical.com/</a>
...
Docker Compose started life as Fig which is something [I have written about before in a previous post](https://media-glass.es/2014/08/31/docker-fig-reverse-proxy-centos7/), the currently release doesn’t add too much in the way of new functionality, but it does start laying the foundations for working with docker-swam, [click here](https://github.com/docker/compose/releases/tag/1.1.0) for the full release notes.

Like docker-machine I installed it using a [Homebrew](http://brew.sh/) formula;

    
     brew install docker-compose
     ==> Downloading <a href="https://homebrew.bintray.com/bottles/fig-1.1.0.yosemite.bottle.1.tar.gz" target="_blank" data-href="https://homebrew.bintray.com/bottles/fig-1.1.0.yosemite.bottle.1.tar.gz">https://homebrew.bintray.com/bottles/fig-1.1.0.yosemite.bottle.1.tar.gz</a>
     ################################################################## 100.0%
...
You can also open your browser using;
     ...
     open <a href="http://%24%28docker-machine" target="_blank" data-href="http://$%28docker-machine">http://$(docker-machine</a> ip)


In my example I see a [phpinfo()](http://php.net/manual/en/function.phpinfo.php) page.
![phpinfo](https://cdn-images-1.medium.com/max/800/0*nEYvANBrPBtA8B_S.png)
...
<blockquote>Note: Swarm is currently in beta, so things are likely to change. We don’t recommend you use it in production yet.</blockquote>
...
Now that’s out of the way lets use [Homebrew](https://brew.sh/) to install docker-swarm;
    ...
    brew install docker-swarm
     ==> Downloading <a href="https://homebrew.bintray.com/bottles/docker-swarm-0.1.0.yosemite.bottle.tar.gz" target="_blank" data-href="https://homebrew.bintray.com/bottles/docker-swarm-0.1.0.yosemite.bottle.tar.gz">https://homebrew.bintray.com/bottles/docker-swarm-0.1.0.yosemite.bottle.tar.gz</a>
     ################################################################## 100.0%
...
Notice how I have pulled _redis_ on “swarm-master” and _mysql_ on “swarm-node-00”, I can now make sure that containers only launch on a node where the image is available;
...
As you can see, docker-swarm is still very much in-development and there are some deal breakers, like containers not being able to talk to each other across nodes. However, with the news that [socketplane.io](http://socketplane.io) (they produce a container based software defined networking solution using Open vSwitch) is [joining Docker](http://blog.docker.com/2015/03/socketplane-excited-to-be-joining-docker-to-collaborate-with-networking-ecosystem/) I don’t think it will be too long before this problem is resolved.
